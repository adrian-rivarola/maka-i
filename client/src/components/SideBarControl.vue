<template>
  <button @click="$store.commit('toggleSideBar')" class="menu-button" tabindex="1">
    <svg
      version="1.1"
    ...
    >
      <path
        v-if="showSideBar"
        d="M466.5,449.5c4.7,4.7,4.7,12.3,0,17c-2.3,2.3-5.4,3.5-8.5,3.5s-6.1-1.2-8.5-3.5L256,273L62.5,466.5
      ...
      <path
        v-else
        d="M444.8,291.1l42.6,24.6c4.9,2.8,7.1,8.6,5.5,14c-11.1,35.6-30,67.8-54.7,94.6c-3.8,4.1-10,5.1-14.8,2.3
